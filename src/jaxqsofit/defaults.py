...
def build_default_prior_config(
    ...
    cfg: Dict[str, Any] = {
        ...
        "edge_rbf_amp": {"dist": "Normal", "loc": 0.0, "scale": 0.05},
        "log_edge_rbf_sigma_blue": {"dist": "LogNormal", "loc": np.log(80.0), "scale": 0.4},
        "log_edge_rbf_sigma_red": {"dist": "LogNormal", "loc": np.log(80.0), "scale": 0.4},
